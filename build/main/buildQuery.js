...
exports.buildQuery = (introspectionResults, factory) => (raFetchType, resName, params) => {
    ...
    switch (raFetchType) {
        case ra_core_1.GET_ONE:
          ...
          ${utils_1.createQueryFromType(resourceTypename, typeMap, typeMapConfiguration, primaryKey)}
        }
        }`,
                variables: {
        ...
        case ra_core_1.GET_MANY:
            return {
                query: utils_1.createGetManyQuery(type, manyLowerResourceName, resourceTypename, typeMap, queryMap, typeMapConfiguration, primaryKey),
                variables: {
                    ids: params.ids
        ...
        case ra_core_1.GET_MANY_REFERENCE:
            return getManyReference_1.getManyReference(params, type, manyLowerResourceName, resourceTypename, pluralizedResourceTypeName, typeMap, queryMap, typeMapConfiguration, primaryKey);
        case ra_core_1.GET_LIST: {
            ...
            return {
                query: utils_1.createGetListQuery(type, manyLowerResourceName, resourceTypename, pluralizedResourceTypeName, typeMap, queryMap, typeMapConfiguration, primaryKey),
