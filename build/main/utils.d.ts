...
import { Query, QueryMap, SortDirection, TypeConfigMap, TypeMap } from './types';
...
export declare const createQueryFromType: (type: string, typeMap: TypeMap, typeConfiguration: TypeConfigMap, primaryKey: PrimaryKey) => string;
export declare const createGetManyQuery: (type: any, manyLowerResourceName: string, resourceTypename: string, typeMap: any, queryMap: QueryMap, typeConfiguration: TypeConfigMap, primaryKey: PrimaryKey) => import("graphql").DocumentNode;
export declare const createGetListQuery: (type: IntrospectionType, manyLowerResourceName: string, resourceTypename: string, pluralizedResourceTypeName: string, typeMap: TypeMap, queryMap: QueryMap, typeConfiguration: TypeConfigMap, primaryKey: PrimaryKey) => import("graphql").DocumentNode;
