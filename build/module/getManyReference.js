...
export var getManyReference = function (params, type, manyLowerResourceName, resourceTypename, typeMap, queryMap, allowedTypes) {
    var _a;
    ...
    return {
        query: createGetListQuery(type, manyLowerResourceName, resourceTypename, typeMap, queryMap, allowedTypes),
        variables: {
