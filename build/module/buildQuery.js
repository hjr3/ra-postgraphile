...
export var buildQuery = function (introspectionResults, factory) { return function (raFetchType, resName, params) {
    ...
    switch (raFetchType) {
        case GET_ONE:
            return {
                query: gql(templateObject_1 || (templateObject_1 = __makeTemplateObject(["query ", "($id: ", "!) {\n          ", "(", ": $id) {\n          ", "\n        }\n        }"], ["query ", "($id: ", "!) {\n          ", "(", ": $id) {\n          ", "\n        }\n        }"])), getResourceName, primaryKeyType.name, getResourceName, idKeyName, createQueryFromType(resourceTypename, typeMap, typeMapConfiguration, primaryKey)),
                variables: {
        ...
        case GET_MANY:
            return {
                query: createGetManyQuery(type, manyLowerResourceName, resourceTypename, typeMap, queryMap, typeMapConfiguration, primaryKey),
                variables: {
                    ids: params.ids
        ...
        case GET_MANY_REFERENCE:
            return getManyReference(params, type, manyLowerResourceName, resourceTypename, pluralizedResourceTypeName, typeMap, queryMap, typeMapConfiguration, primaryKey);
        case GET_LIST: {
            ...
            return {
                query: createGetListQuery(type, manyLowerResourceName, resourceTypename, pluralizedResourceTypeName, typeMap, queryMap, typeMapConfiguration, primaryKey),
        ...
        case CREATE: {
            ...
            return {
                variables: variables,
                query: gql(templateObject_2 || (templateObject_2 = __makeTemplateObject(["mutation create", "($input: Create", "Input!) {\n          create", " (\n          input: $input\n        ) {\n          ", " {\n          ", "\n        }\n        }\n        }"], ["mutation create", "($input: Create", "Input!) {\n          create", " (\n          input: $input\n        ) {\n          ", " {\n          ", "\n        }\n        }\n        }"])), resourceTypename, resourceTypename, resourceTypename, singleLowerResourceName, createQueryFromType(resourceTypename, typeMap, typeMapConfiguration, primaryKey)),
        ...
        case DELETE: {
            return {
                ...
                query: gql(templateObject_3 || (templateObject_3 = __makeTemplateObject(["\n          mutation ", "($input: Delete", "Input!) {\n            ", "(input: $input) {\n            ", " {\n            ", "\n          }\n          }\n          }\n        "], ["\n          mutation ", "($input: Delete", "Input!) {\n            ", "(input: $input) {\n            ", " {\n            ", "\n          }\n          }\n          }\n        "])), deleteResourceName, resourceTypename, deleteResourceName, singleLowerResourceName, createQueryFromType(resourceTypename, typeMap, typeMapConfiguration, primaryKey)),
                parseResponse: function (response) { return ({
        ...
        case UPDATE: {
            ...
            return {
                ...
                query: gql(templateObject_5 || (templateObject_5 = __makeTemplateObject(["\n          mutation ", "($input: Update", "Input!) {\n            ", "(input: $input) {\n            ", " {\n            ", "\n          }\n          }\n          }\n        "], ["\n          mutation ", "($input: Update", "Input!) {\n            ", "(input: $input) {\n            ", " {\n            ", "\n          }\n          }\n          }\n        "])), updateResourceName, resourceTypename, updateResourceName, singleLowerResourceName, createQueryFromType(resourceTypename, typeMap, typeMapConfiguration, primaryKey)),
                parseResponse: function (response) { return ({
