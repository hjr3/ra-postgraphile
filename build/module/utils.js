...
var shouldQueryField = function (fieldName, typeConfig) {
...
export var createQueryFromType = function (type, typeMap, typeConfiguration, primaryKey) {
    return typeMap[type].fields.reduce(function (current, field) {
        ...
        if (fieldIsObjectOrListOfObject(field)) {
            var thisType = ((_a = field.type.ofType) === null || _a === void 0 ? void 0 : _a.name) ? field.type.ofType
                : // We also handle cases where we have e.g. [TYPE!] (List of type)
                 (_b = field.type.ofType) === null || _b === void 0 ? void 0 : _b.ofType;
            var typeName = (thisType && thisType.name) || field.type.name;
            var shouldExpand = typeName && typeConfiguration[typeName] && typeConfiguration[typeName].expand;
            if (typeName && shouldExpand) {
                return "\n        " + current + " " + field.name + " {" + createQueryFromType(typeName, typeMap, typeConfiguration, primaryKey) + " }\n        ";
            }
...
export var createGetManyQuery = function (type, manyLowerResourceName, resourceTypename, typeMap, queryMap, typeConfiguration, primaryKey) {
    if (!queryHasArgument(manyLowerResourceName, ARGUMENT_FILTER, queryMap)) {
        return gql(templateObject_1 || (templateObject_1 = __makeTemplateObject(["query ", "{\n      ", " {\n      nodes {\n        ", "\n      }\n    }\n    }"], ["query ", "{\n      ", " {\n      nodes {\n        ", "\n      }\n    }\n    }"])), manyLowerResourceName, manyLowerResourceName, createQueryFromType(resourceTypename, typeMap, typeConfiguration, primaryKey));
    }
    return gql(templateObject_2 || (templateObject_2 = __makeTemplateObject(["\n    query ", "($ids: [", "!]) {\n      ", "(filter: { ", ": { in: $ids }}) {\n      nodes {\n        ", "\n      }\n    }\n    }"], ["\n    query ", "($ids: [", "!]) {\n      ", "(filter: { ", ": { in: $ids }}) {\n      nodes {\n        ", "\n      }\n    }\n    }"])), manyLowerResourceName, primaryKey.primaryKeyType.name, manyLowerResourceName, primaryKey.primaryKeyName, createQueryFromType(resourceTypename, typeMap, typeConfiguration, primaryKey));
};
...
export var createGetListQuery = function (type, manyLowerResourceName, resourceTypename, pluralizedResourceTypeName, typeMap, queryMap, typeConfiguration, primaryKey) {
    ...
    if (!hasFilters && hasOrdering) {
        return gql(templateObject_4 || (templateObject_4 = __makeTemplateObject(["query ", " (\n    $offset: Int!,\n    $first: Int!,\n    $orderBy: [", "OrderBy!]\n    ) {\n      ", "(first: $first, offset: $offset, orderBy: $orderBy) {\n      nodes {\n        ", "\n      }\n      totalCount\n    }\n    }"], ["query ", " (\n    $offset: Int!,\n    $first: Int!,\n    $orderBy: [", "OrderBy!]\n    ) {\n      ", "(first: $first, offset: $offset, orderBy: $orderBy) {\n      nodes {\n        ", "\n      }\n      totalCount\n    }\n    }"])), manyLowerResourceName, pluralizedResourceTypeName, manyLowerResourceName, createQueryFromType(resourceTypename, typeMap, typeConfiguration, primaryKey));
    }
    if (hasFilters && !hasOrdering) {
        return gql(templateObject_5 || (templateObject_5 = __makeTemplateObject(["query ", " (\n    $offset: Int!,\n    $first: Int!,\n    $filter: ", "Filter,\n    ) {\n      ", "(first: $first, offset: $offset, filter: $filter) {\n      nodes {\n        ", "\n      }\n      totalCount\n    }\n    }"], ["query ", " (\n    $offset: Int!,\n    $first: Int!,\n    $filter: ", "Filter,\n    ) {\n      ", "(first: $first, offset: $offset, filter: $filter) {\n      nodes {\n        ", "\n      }\n      totalCount\n    }\n    }"])), manyLowerResourceName, resourceTypename, manyLowerResourceName, createQueryFromType(resourceTypename, typeMap, typeConfiguration, primaryKey));
    }
    return gql(templateObject_6 || (templateObject_6 = __makeTemplateObject(["query ", " (\n  $offset: Int!,\n  $first: Int!,\n  $filter: ", "Filter,\n  $orderBy: [", "OrderBy!]\n  ) {\n    ", "(first: $first, offset: $offset, filter: $filter, orderBy: $orderBy) {\n    nodes {\n      ", "\n    }\n    totalCount\n  }\n  }"], ["query ", " (\n  $offset: Int!,\n  $first: Int!,\n  $filter: ", "Filter,\n  $orderBy: [", "OrderBy!]\n  ) {\n    ", "(first: $first, offset: $offset, filter: $filter, orderBy: $orderBy) {\n    nodes {\n      ", "\n    }\n    totalCount\n  }\n  }"])), manyLowerResourceName, resourceTypename, pluralizedResourceTypeName, manyLowerResourceName, createQueryFromType(resourceTypename, typeMap, typeConfiguration, primaryKey));
};
