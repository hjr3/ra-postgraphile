...
export var factory = function (client, options, graphqlProviderOptions) {
    if (options === void 0) { options = { queryValueToInputValueMap: {} }; }
    if (graphqlProviderOptions === void 0) { graphqlProviderOptions = {}; }
    var defaultAppliedOptions = {
        queryValueToInputValueMap: __assign(__assign({}, defaultQueryValueToInputValueMap), (options.queryValueToInputValueMap || {}))
    };
